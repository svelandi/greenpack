...
<body>
  ...
  <div id="Plantilla_Cotizacion (3)_10772" align="center" x:publishsource="Excel">
    <table border="0" cellpadding="0" cellspacing="0" width="600" style="border-collapse:collapse;table-layout:fixed;width: 100%;margin: 0 auto;">
      <colgroup>
        <col width="75" span="7" style="mso-width-source:userset;mso-width-alt:2742;width:56pt">
      ...
      <tbody>
        <tr height="20" style="mso-height-source:userset;height:15.0pt">
          <td colspan="5" rowspan="5" height="108" width="375" style="height:81.0pt;width:280pt" align="left" valign="top"><span style="mso-ignore:vglayout;position:absolute;z-index:1;margin-left:45px;margin-top:20px;width:245px;height:66px">
        ...
        <tr height="20" style="mso-height-source:userset;height:15.0pt">
          <td colspan="3" height="20" class="xl7610772" style="height:15.0pt">NIT 800,025,125-8</td>
        ...
        <tr height="28" style="mso-height-source:userset;height:15.0pt">
          <td colspan="3" height="26" class="xl7610772" style="height:26px">Cra. 5 este No. 20-69 Bodega # 6</td>
          <td class="xl1510772"></td>
          <td colspan="2" rowspan="3" class="xl8110772"><?= $quotation->getId() ?></td>
        </tr>
        <tr height="28" style="mso-height-source:userset;height:15.0pt">
          <td colspan="3" height="20" class="xl7610772" style="height:26px">&nbsp;(57+1) 893 26 31 / 35/ 38/ 42</td>
          <td class="xl1510772"></td>
        </tr>
        <tr height="20" style="height:15.0pt">
          <td colspan="3" height="20" class="xl7610772" style="height:26px">Mosquera - Cundinamarca</td>
          <td class="xl1510772"></td>
        </tr>
        ...
        <tr height="20" style="height:15.0pt">
          <td colspan="2" height="20" class="xl6710772" style="height:15.0pt">Nombres y Apellidos</td>
        ...
        <tr height="40" style="height:30.0pt">
          <td colspan="2" height="40" class="xl9010772" style="border-right:.5pt solid black;height:30.0pt">Producto</td>
          <td colspan="4" class="xl9010772" style="border-right:.5pt solid black;border-left:none">Descripcion</td>
          <td colspan="2" class="xl9010772" style="border-right:.5pt solid black;border-left:none">Cantidad<span style="mso-spacerun:yes">&nbsp;</span></td>
          <td class="xl7010772" width="80" style="border-left:none;width:60pt">Precio Unidad</td>
        ...
        foreach ($quotation->getItems() as $item) { ?>
          ...
          <tr height="48" style="mso-height-source:userset;height:36.0pt">
            <td colspan="2" height="48" class="xl8810772" width="150" style="height:36.0pt;width:112pt">
              <img src="<?= $item->getProduct()->getImages()[0]->getUrl() ?>" width="70" height="70" style="margin: 2px;">
            </td>
            <td colspan="4" class="xl7710772" width="375" style="width:280pt;vertical-align: middle!important;">
              ...
              <font class="font010772"> <?= $item->getProduct()->getname() ?> </font>
              <br>
        ...
        <!-- <tr height="21" style="mso-height-source:userset;height:15.75pt">
          <td colspan="11" height="21" class="xl6810772" style="height:15.75pt">Impresos 15 dias</td>
        </tr> -->
        <tr height="21" style="mso-height-source:userset;height:15.75pt">
          <td height="21" class="xl1510772" style="height:15.75pt"></td>
          <td class="xl1510772"></td>
